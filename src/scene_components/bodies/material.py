...
class Material:
    ...
    def _shader(self, collide: Vec3, normal: Vec3, reflected: Vec3, ambient: Vec3, light_sources: list, ray_model: RayModel) -> tuple:
        ...
        light_full = ambient + Vec3(1 - ambient.x, 1 - ambient.y, 1 - ambient.z) * (diffuse_integral * (1 - self._gloiness) + specular_integral * self._gloiness)
