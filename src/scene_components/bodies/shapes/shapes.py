...
class Box(ShapeBase):
    def __init__(pos: Vec3, size: Vec3):
        pass
...
class Sphere(ShapeBase): 
    def __init__(pos: Vec3, radius: float):
        pass
...
class ClampedCylinder(ShapeBase):
    def __init__(pos: Vec3, radius: float, height: float):
        pass
...
class Plane(ShapeBase): 
    def __init__(pos: Vec3, normal: Vec3):
        pass
...
class Disk(ShapeBase):
    def __init__(pos: Vec3, radius: float, normal: Vec3):
        pass
